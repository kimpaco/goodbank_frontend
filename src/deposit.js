...
const Deposit = () => {
    ...
    const transaction = () => {
        ...
        .then((data) => {
            getData();
            alert(`Your deposit for $${trans} has been successful`);
        }) 
    }
    ...
    return (
        ...
        bgcolor="light"
        image={cashier}
        header="Cash Deposit Operations"
        error={error}
        body={<>
        ...
        <button type="submit" className="btn btn-secondary" onClick={transaction} disabled={disable}>Deposit</button>
        </>}
        />
        </>
